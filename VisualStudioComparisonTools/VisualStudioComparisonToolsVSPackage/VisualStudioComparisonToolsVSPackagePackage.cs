...
namespace VisualStudioComparisonToolsVSPackage
{
    ...
    [Guid(GuidList.guidVisualStudioComparisonToolsVSPackagePkgString)]
    public sealed class VisualStudioComparisonToolsVSPackagePackage : Package
    {
        ...
        /// </summary>
        public VisualStudioComparisonToolsVSPackagePackage()
        {
        ...
        protected override void Initialize()
        {
            ...
            if ( null != mcs )
            {
                ...
                var menuCommandID = new CommandID(GuidList.guidVisualStudioComparisonToolsVSPackageCmdSet, (int)PkgCmdIDList.cmdidCompareSelected);
                //var menuItem = new MenuCommand(MenuItemCallback, menuCommandID);
                var menuItem = new OleMenuCommand(MenuItemCallback, menuCommandID);
                menuItem.BeforeQueryStatus += menuItem_BeforeQueryStatus;
                mcs.AddCommand( menuItem );

                var menuCommandIDFolder = new CommandID(GuidList.guidVisualStudioComparisonToolsVSPackageCmdSet, (int)PkgCmdIDList.cmdidCompareSelectedFolder);
                //var menuItem = new MenuCommand(MenuItemCallback, menuCommandID);
                ...
                var menuCommandIDEditor = new CommandID(GuidList.guidVisualStudioComparisonToolsVSPackageCmdSet, (int)PkgCmdIDList.cmdidCompareSelectedEditor);
                //var menuItem = new MenuCommand(MenuItemCallback, menuCommandID);
                ...
                var menuCommandIDMultiProj = new CommandID(GuidList.guidVisualStudioComparisonToolsVSPackageCmdSet, (int)PkgCmdIDList.cmdidCompareSelectedMultiProj);
                //var menuItem = new MenuCommand(MenuItemCallback, menuCommandID);
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            //if (_applicationObject.SelectedItems.Count > 0)
            {
                ...
                {
                    var myCommand = sender as OleMenuCommand;
                    if (myCommand != null && myCommand.CommandID.Guid == GuidList.guidVisualStudioComparisonToolsVSPackageCmdSet &&

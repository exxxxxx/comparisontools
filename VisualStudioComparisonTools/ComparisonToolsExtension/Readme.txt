...
Configuration
    ...
    * Configuration file can be found from Environment.SpecialFolder.CommonApplicationData \ ComparisonToolsExtension\ config.xml
          o (In Vista and Windows 7: C:\ProgramData\Comparison Tools Extension)
...
Problems
    ...
    * If the "Compare to Clipboard" text doesn't appear in the right click context menu, try the following:
          ...
          o Write "devenv.exe /resetaddin ComparisonToolsExtension.Connect" and press enter.
    * If you encounter any problems, copy the file "ComparisonToolsExtension.dll.log4net" and log4net.dll from the application directory to the location of devenv.exe. A ComparisonToolsExtension-log.txt file will be created.

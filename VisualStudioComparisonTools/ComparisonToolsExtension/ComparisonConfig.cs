...
namespace ComparisonToolsExtension
{
    public class ComparisonConfig
    {
        ...
        {
            ConfigPath = Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData) + Path.DirectorySeparatorChar + "Comparison Tools Extension";
        ...
        public void Save()
        {
            DataSet config = new DataSet("ComparisonToolsExtension");
